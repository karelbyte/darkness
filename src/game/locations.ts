...
export const gameLocations: Location[] = [
  ...
  },
  {
    ...
    image: '/images/abandoned-cabin.jpg',
    exits: [
      {
        direction: 'oeste',
        targetLocationId: 'start',
  ...
  },
  {
    ...
    image: '/images/moonlit-clearing.jpg',
    exits: [
      {
        direction: 'sur',
        targetLocationId: 'deep-forest',
  ...
  },
  {
    ...
    image: '/images/mysterious-cave.jpg',
    exits: [
      {
        direction: 'este',
        targetLocationId: 'deep-forest',
